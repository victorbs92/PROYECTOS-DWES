...
if (isset($_SESSION['nombreUsuario'])) {//si en la sesion existe la variable nombreUsuario (creada en el login)
    if (isset($_POST['cerrarSesion'])) {//si se ha pulsado el boton cerrarSesion
        ...
        $tituloArticulo = $_SESSION['arrayArticulos'][$_SESSION['idArticulo']]->getTituloArticulo();
        $fechaArticulo = $_SESSION['arrayArticulos'][$_SESSION['idArticulo']]->getFechaArticulo();
        $descripcionArticulo = $_SESSION['arrayArticulos'][$_SESSION['idArticulo']]->getDescripcionArticulo();
