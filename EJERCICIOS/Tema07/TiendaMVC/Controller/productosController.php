...
if (isset($_SESSION['nombreUsuario'])) {//si en la sesion existe la variable nombreUsuario (creada en el login)
    ...
    if (isset($_POST['cerrarSesion'])) {//si se ha pulsado el boton cerrarSesion
    ...
    } else if (isset($_POST['añadir'])) {//comprobamos si se ha enviado el formulario habiendo pulsado el boton de añadir
    } else if (isset($_POST['cesta'])) { //si se ha pulsado el boton ver cesta
    } else if (isset($_POST['vaciar'])) { //si se ha pulsado el boton vaciar cesta
        ...
        include_once '../View/productosView.php'; //incluye la vista para mostrarla en pantalla
    }
